...
import bstyles from "./Esublist.module.css"
...
export default function Emodal_menu(){
    ...
    const BackButtonDiv = <div className={bstyles.backButtonBar} onClick={()=>handleBack()}>
        <button className={`${bstyles.backButton} ${bstyles.button} ${bstyles.button_medium}`}>
            <ArrowBackIosNewIcon sx={{marginRight:5+'px'}} fontSize="small"/>
            Back to {subcategory_info.title}
        </button>
    </div>
    return(
        <div className={`${styles.menusContainer}`}>
            {Submenu ? BackButtonDiv : ''}
            <div className={`${styles.menuContainer} ${styles.L1_buy_and_sell}
                ${Itemstate[0] ? styles.menu_Container_isActive: ''}`} role="group"
                >
                <div className={Itemstate[0] && !Submenu ? `${styles.listContainer}`:`${styles.listContainer} ${styles.listContainer_isHidden}`}>
                    ...
                    <ul className={styles.categoryList} role="menu">
                        ...
                        <li className={styles.categoryItem} role="none" onClick={()=>handleSearch("Audio")}>
                            <a className={`${styles.menuLink} ${styles.button_en} ${styles.button_medium}`}>
                        ...
                        <li className={styles.categoryItem} role="none" 
                         onClick={()=>{handleSearch("Baby Items")}}>
                            <a className={`${styles.menuLink} ${styles.button_en} ${styles.button_medium}`}>
                ...
                <div className={styles.menuFlyout}>
                    {(Submenu && Itemstate[0]) && <Esublist {...subcategory_info}></Esublist>}
                </div>
            </div>
            <div className={`${styles.menuContainer} ${styles.L1_cars_and_vehicles}
                ${Itemstate[1] ? styles.menu_Container_isActive: ''}`} role="group">
                <div className={(!Submenu && Itemstate[1])? `${styles.listContainer}`:`${styles.listContainer} ${styles.listContainer_isHidden}`}>
                    ...
                    <ul className={styles.categoryList} role="menu">
                        ...
                        <li className={styles.categoryItem} role="none" onClick={()=>handleSearch("Vehicle Parts, Tires, & Accessories")}
                            >
                            <a className={`${styles.menuLink} ${styles.button_en} ${styles.button_medium}`}>
                        ...
                        <li className={styles.categoryItem} role="none" onClick={()=>handleSearch("Automotive Services")}>
                            <a className={`${styles.menuLink} ${styles.button_en} ${styles.button_medium}`}>
                ...
                <div className={styles.menuFlyout}>
                    {(Submenu && Itemstate[1]) && <Esublist {...subcategory_info}></Esublist>}
                </div>
            </div>
            <div className={`${styles.menuContainer} ${styles.L1_real_estate}
                ${Itemstate[2] ? styles.menu_Container_isActive: ''}`} role="group">
                <div className={(!Submenu && Itemstate[2])? `${styles.listContainer}`:`${styles.listContainer} ${styles.listContainer_isHidden}`}>
                    <h3 className={styles.categoryName}>Buy & Sell</h3>
                    <ul className={styles.categoryList} role="menu">
                        <li className={styles.categoryItem} role="none">
                            <a className={`${styles.link_title} ${styles.link_default} ${styles.seeAllLink}`} 
                        ...
                        <li className={styles.categoryItem} role="none" onClick={()=>handleSearch("For Rent")}>
                            <a className={`${styles.menuLink} ${styles.brandedLink}`} href="#"> 
                                    For Rent
                                    <ArrowForwardIosIcon fontSize="small" className={`${styles.icon_arrow} 
                                    ${styles.moreCategoriesIcon}`}/>
                        ...
                        <li className={styles.categoryItem} role="none" onClick={()=>handleSearch("For Sale")}>
                            <a className={`${styles.menuLink} ${styles.button_en} ${styles.button_medium}`}>
                ...
                <div className={styles.menuFlyout}>
                    {(Submenu && Itemstate[2]) && <Esublist {...subcategory_info}></Esublist>}
                </div>
            </div>
            <div className={`${styles.menuContainer} ${styles.L1_jobs}
                ${(Itemstate[3]) ? styles.menu_Container_isActive: ''}`} role="group">
                <div className={(!Submenu && Itemstate[3])? `${styles.listContainer}`:`${styles.listContainer} ${styles.listContainer_isHidden}`}>
                ...
                <div className={styles.menuFlyout}>
                    {(Submenu && Itemstate[3]) && <Esublist {...subcategory_info}></Esublist>}
                </div>
            </div>
            <div className={`${styles.menuContainer} ${styles.L1_services}
                ${(Itemstate[4]) ? styles.menu_Container_isActive: ''}`} role="group">
                <div className={(!Submenu && Itemstate[4])? `${styles.listContainer}`:`${styles.listContainer} ${styles.listContainer_isHidden}`}>
                    ...
                    <ul className={styles.categoryList} role="menu">
                        ...
                        <li className={styles.categoryItem} role="none" onClick={()=>handleSearch("Skilled Trades")}>
                            <a className={`${styles.menuLink} ${styles.button_en} ${styles.button_medium}`}>
                ...
                <div className={styles.menuFlyout}>
                    {(Submenu && Itemstate[4]) && <Esublist {...subcategory_info}></Esublist>}
                </div>
            </div>
            <div className={`${styles.menuContainer} ${styles.L1_pets}
                ${(Itemstate[5]) ? styles.menu_Container_isActive: ''}`} role="group">
                <div className={(!Submenu && Itemstate[5])? `${styles.listContainer}`:`${styles.listContainer} ${styles.listContainer_isHidden}`}>
                ...
                <div className={styles.menuFlyout}>
                    {(Submenu && Itemstate[5]) && <Esublist {...subcategory_info}></Esublist>}
                </div>
            </div>
            <div className={`${styles.menuContainer} ${styles.L1_community} ${(Itemstate[6]) ? 
                    styles.menu_Container_isActive: ''}`} role="group" >
                <div className={(!Submenu && Itemstate[6])? `${styles.listContainer}`:`${styles.listContainer} ${styles.listContainer_isHidden}`}>
                ...
                <div className={styles.menuFlyout}>
                    {(Submenu && Itemstate[6]) && <Esublist {...subcategory_info}></Esublist>}
                </div>
            </div>
            <div className={`${styles.menuContainer} ${styles.L1_vacation_rentals}
                ${(Itemstate[7]) ? styles.menu_Container_isActive: ''}`} 
                    role="group" >
                <div className={(!Submenu && Itemstate[7])? `${styles.listContainer}`:`${styles.listContainer} ${styles.listContainer_isHidden}`}>
                    ...
                    <ul className={styles.categoryList} role="menu">
                        ...
                        <li className={styles.categoryItem} role="none" onClick={()=>handleSearch("Canada")}>
                            <a className={`${styles.menuLink} ${styles.button_en} ${styles.button_medium}`}>
                        ...
                        <li className={styles.categoryItem} role="none" onClick={()=>handleSearch("USA")}>
                            <a className={`${styles.menuLink} ${styles.button_en} ${styles.button_medium}`}>
                ...
                <div className={styles.menuFlyout}>
                    {(Submenu && Itemstate[7]) && <Esublist {...subcategory_info}></Esublist>}
                </div>
            </div>
        </div>
    )
